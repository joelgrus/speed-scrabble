...
import { DEFAULT_GAME_RULES, TIMED_GAME_CONFIG, SCORING_CONFIG } from './config';

/**
 * Validates base game rules
 */
export function validateBaseRules(rules: Partial<BaseRules>): BaseRules | null {
 ...
 */
export function validateTimedRules(rules: Partial<TimedGameRules>): TimedGameRules | null {
 ...
 */
export function createGameRules(mode: GameMode, customRules?: Partial<BaseRules | TimedGameRules>): GameRules | null {
  switch (mode) {
    case 'classic': {
 ...
 */
export function getEffectiveRules(gameRules: GameRules): BaseRules {
 ...
 */
export function isTimedMode(gameRules: GameRules): gameRules is GameRules & { timed: TimedGameRules } {
 ...
 */
export function getTimedRules(gameRules: GameRules): TimedGameRules | null {
 ...
 */
export function createClassicRules(): GameRules {
  return {
    mode: 'classic',
 ...
 */
export function createTimedRules(): GameRules {
 ...
 */
export function migrateFromLegacyRules(legacyRules: BaseRules): GameRules {
  return {
    mode: 'classic',
    base: legacyRules,
  };
