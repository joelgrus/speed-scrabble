...
import { CoordZ, LetterZ, TileZ, PlacedTileZ, BoardZ, GameModeZ, BaseRulesZ, TimedGameRulesZ, GameRulesZ, RulesZ, CursorZ, ValidationResultZ, } from '../schemas';
describe('Schema Type Alignment', () => {
    describe('CoordZ', () => {
        it('should validate valid coordinates', () => {
            const validCoord = { x: 5, y: -3 };
    ...
    describe('TileZ', () => {
        it('should validate valid tiles', () => {
            const validTile = { id: 't1', letter: 'A' };
    ...
    describe('PlacedTileZ', () => {
        it('should validate valid placed tiles', () => {
            const validPlacedTile = { id: 't1', letter: 'A', x: 5, y: -3 };
    ...
    describe('GameModeZ', () => {
        it('should validate all game modes', () => {
            const modes = ['classic', 'timed', 'custom'];
            modes.forEach(mode => {
